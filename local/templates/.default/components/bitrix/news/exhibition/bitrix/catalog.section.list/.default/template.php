...
if (strlen($arResult["SECTION"]["DESCRIPTION"]) > 0):?>
	<p class="im-common-mb25"><?echo $arResult["SECTION"]["DESCRIPTION"];?></p>
<?endif;

if ($arResult["SECTIONS_COUNT"] > 0):
?>
	<ul class="im-gallery-menu im-common-clearfix im-common-list">
		<?foreach ($arResult['SECTIONS'] as &$arSection):
			$this->AddEditAction($arSection['ID'], $arSection['EDIT_LINK'], $strSectionEdit);
			$this->AddDeleteAction($arSection['ID'], $arSection['DELETE_LINK'], $strSectionDelete, $arSectionDeleteParams);
			?>
			<li id="<?=$this->GetEditAreaId($arSection['ID']);?>">
				<a href="<?=$arSection["SECTION_PAGE_URL"];?>" class="im-common-img_block" style="background-image: url(<?=$arSection["PICTURE"]["SRC"]?>)">
					<div class="im-common-img_block-caption"><div><?echo $arSection["NAME"]?></div></div>
				</a>		
			</li>
		<?endforeach;?>	
	</ul>
