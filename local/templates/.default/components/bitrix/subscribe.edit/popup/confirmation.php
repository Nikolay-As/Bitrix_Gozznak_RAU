...
<div class="news-subscribe-alert news-subscribe-alert--message">
	<p class="is-big color-green">
		Спасибо за подписку!
	</p>
	<p>
		Вам отправлено письмо с подтверждением.<br />Пожалуйста, кликните в письме на ссылку <strong>"Подтвердить подписку"</strong>.
	</p>
</div>
