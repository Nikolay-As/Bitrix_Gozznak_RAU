...
<form action="<?=$arResult["FORM_ACTION"]?>" method="get">
	...
	<div class="im-common-mb30">
		...
		<?elseif($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"):?>
			<p class="im-common-clr-green"><?echo GetMessage("subscr_title_status_note2")?></p>
	...
	<div class="im-common-ac">
		<?if($arResult["SUBSCRIPTION"]["CONFIRMED"] == "Y"):?>		
			<?if($arResult["SUBSCRIPTION"]["ACTIVE"] == "Y"):?>
				<button type="submit" name="unsubscribe" class="button"><?echo GetMessage("subscr_unsubscr")?></button>
				<input type="hidden" name="unsubscribe" value="<?echo GetMessage("subscr_unsubscr")?>" />
				<input type="hidden" name="action" value="unsubscribe" />
			<?else:?>
				<button type="submit" name="activate" class="button"><?echo GetMessage("subscr_activate")?></button>
