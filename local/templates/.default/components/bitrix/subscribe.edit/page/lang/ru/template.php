...
$MESS ['subscr_status_note3'] = "Если вы хотите отписаться от рассылки, нажмите на кнопку \"Отписаться\".";
$MESS ['subscr_status_note4'] = "Ваша подписка подтверждена, но не активна.";
$MESS ['subscr_status_note5'] = "Если вы хотите возобновить получение рассылки, нажмите на кнопку \"Возобновить\".";
$MESS ['subscr_unsubscr'] = "Отписаться";
$MESS ['subscr_activate'] = "Возобновить";
...
$MESS ['FORM_FOOTER_AGREE_TEXT_1'] = 'Нажимая кнопку "';
$MESS ['FORM_FOOTER_AGREE_TEXT_2'] = '", я даю согласие';
$MESS ['FORM_FOOTER_AGREE_LINK_TEXT'] = 'на обработку своих персональных данных';

$MESS ['FORM_VALIDATE_EMPTY'] = "Пожалуйста, заполните обязательные поля";
$MESS ['FORM_INVALID_EMAIL'] = "Пожалуйста, укажите корректный e-mail";
?>