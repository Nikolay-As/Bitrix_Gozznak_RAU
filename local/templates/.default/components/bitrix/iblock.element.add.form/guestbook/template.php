...
if (strlen($arResult["MESSAGE"]) > 0):?>
	<script>
		$.dwbox.loadHtml('<div style="width:480px;"><div class="im-current_section im-common-bg im-common-ac"><?=GetMessage("IBLOCK_FORM_SUCCESS_CAPTION");?></div><div style="margin: 20px;" class="im-wa"><div class="im-common-ac"><p><?=$arResult["MESSAGE"]?></p></div></div></div>');
	</script>
<?else:?>
	<div class="im-common-heading-big im-common-mb10"><?=$GetMessage["IBLOCK_FORM_TITLE"]?></div>
	<hr class="im-common-mb30" />
	...
	<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
		...
		<?if (is_array($arResult["PROPERTY_LIST"]) && !empty($arResult["PROPERTY_LIST"])):?>
			...
			<div class="im-common-mb30">			
				...
				<?if($arParams["USE_CAPTCHA"] == "Y" && $arParams["ID"] <= 0):?>
					<div class="im-common-mb20 im-common-clearfix">					
						<input type="hidden" name="captcha_sid" value="<?=$arResult["CAPTCHA_CODE"]?>" />					
						<img src="/bitrix/tools/captcha.php?captcha_sid=<?=$arResult["CAPTCHA_CODE"]?>" style="width:180px;height:40px;" width="180" height="40" class="im-common-captcha" alt="CAPTCHA" />					
						<p class="im-common-clr-black im-common-mb3 im-commo-mr20 im-common-clear"><?=GetMessage("IBLOCK_FORM_CAPTCHA_PROMPT")?>:<span class="im-common-required">*</span></p>					
		...
		<div class="im-common-ac">
			<input type="submit" name="iblock_submit" class="im-common-button im-common-button__wide" value="<?=GetMessage("IBLOCK_FORM_SUBMIT")?>" />			
		</div>		
