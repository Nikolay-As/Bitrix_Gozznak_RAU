...
{
	// first page url
	$arResult["NAV"]["URL"]["FIRST_PAGE"] = MakeNewNavUrl(array($arResult["NAV"]["PAGER_ID"]=>$arResult["NAV"]["PAGE_COUNT"]));

	// previous page url
	$arResult["NAV"]["URL"]["PREV_PAGE"]  = MakeNewNavUrl(array($arResult["NAV"]["PAGER_ID"]=>$arResult["NAV"]["PAGE_NUMBER"]+1));

	// last page url
	$arResult["NAV"]["URL"]["LAST_PAGE"]  = MakeNewNavUrl(array($arResult["NAV"]["PAGER_ID"]=>"1"));

	// next page url
	$arResult["NAV"]["URL"]["NEXT_PAGE"] = MakeNewNavUrl(array($arResult["NAV"]["PAGER_ID"]=>$arResult["NAV"]["PAGE_NUMBER"]-1));

	// some page url
	for ($i=$arResult["NAV"]["END_PAGE"]; $i<=$arResult["NAV"]["START_PAGE"]; $i++)
	{
