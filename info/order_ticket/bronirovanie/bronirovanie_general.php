...
$APPLICATION->SetTitle($_POST["type_excursion"]);
?><style>
    body {
        font-family: Arial;
    }
...
<body>
    ...
    <div class="buy-banner-main">
        <div class="tab">
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => $url_1c . '/hs/RAU_info_for_site/general_applications',
                ...
                CURLOPT_HTTPHEADER => array(
                    ...
                    'type_excursion:' . iconv("utf-8", "windows-1251", $_POST["type_excursion"])
                ),
            ));
    ...
    <?php
        ...
        <div id="<?php echo $current_month ?>" class="tabcontentt">
            ...
            ?>
                <form action="Requisites.php" method="post">
                    <div class="main_bblock">
                        <div class="main_bblock1">
                            <div class="bblock1"> <!-- Блок с датой -->
                                <span class=""><input type="hidden" name="date" value="<?php echo $day ?>" /><?php echo $day ?></span>
                                <span class=""><?php echo $months_slant[$current_month] ?></span>
                            </div>
                            <div class="bblock2"> <!-- Блок с временем и днем недели -->
                                <span class=""><?php echo $day_of_week ?></span>
                                <span class=""><input type="hidden" name="time" value="<?php echo $time ?>" /><?php echo $time ?></span>
                            </div>
                            <div class="bblock3">
                                <span class=""><input type="hidden" name="info_site" value="<?php echo $line_current_month->ИнформацияДляСайта ?>" /><?php echo $line_current_month->ИнформацияДляСайта ?></span>
                            </div>
                            <div class="bblock5">
                                <button data-key="" class="Button-sc-3k6hpk-0 Action__ActionButton-sc-1iie49r-0 __get-button__Button-sc-3tp1b1-0 bQgTwa mMNjC gfolnF SessionButton" label="[object Object]">
                                    <a href=<?php echo $url_site . "/info/order_ticket/bronirovanie/Requisites.php" ?>><span data-component="CommonPrice" class="">Забронировать</span></a>
                                </button>
                                <p class="bblock5_p">Остаток билетов: <?php echo $balance ?></p>

                            </div>
                        </div>
                        <!-- <div class="main_bblock2"> -->
                        <!-- Блок с инфо для сайта -->
                        <!-- <div class="bblock3"> 
                    ...
                    <input type="hidden" name="title" value="<?php echo $_POST["type_excursion"] ?>" />
